...
class UserFormDialogAdm extends StatefulWidget {
  final UserProfileModel? user;

  const UserFormDialogAdm({super.key, this.user});

  @override
  State<UserFormDialogAdm> createState() => _UserFormDialogAdmState();
}

class _UserFormDialogAdmState extends State<UserFormDialogAdm> {
      ...
      try {
        ...
        if (creatorUid != null) {
          ...
          if (creatorDoc.exists) {
            ...
            creatorInfo =
                '${creator.email} ${creator.firstName} ${creator.lastName}';
          }
        }
