...
class EvaluationFormPage4 extends StatefulWidget {
  final String module;
  final String theme;
  final DocumentSnapshot? document;

  const EvaluationFormPage4({
  ...
  @override
  State<EvaluationFormPage4> createState() => _EvaluationFormPageState();
}

class _EvaluationFormPageState extends State<EvaluationFormPage4> {
  ...
  final Map<String, String> bonnesReponses = {
    'q1': 'C\'est un moyen de communication entre DIEU et nous',
    'q2': 'C\'est le carburant de l\'âme',
    'q3': 'chaque jeudi à minuit',
    'q3s': 'toute la nuit et tôt le matin',
    'q4': 'Sur la volonté de DIEU',
  };
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      buildRadioQuestion(
                        ...
                        [
                          'C\'est  parler aux anges',
                          'C\'est parler aux bois',
                          'C\'est un moyen de communication entre DIEU et nous',
                          'C\'est parler aux statues',
                          'Je ne sais pas',
                        ],
                        q1,
                        (val) => setState(() => q1 = val),
                      ...
                      buildRadioQuestion(
                        ...
                        [
                          'Cela nous met en contact avec les anges',
                          'Cela nous purifie',
                          'Cela nous rapproche des hommes',
                          'C\'est le carburant de l\'âme',
                          'Je ne sais pas',
                        ],
                        q2,
                        (val) => setState(() => q2 = val),
                      ...
                      buildRadioQuestion(
                        "Quels sont les temps prière ?",
                        [
                          'A 6h',
                          'A 8h',
                          'chaque jeudi à minuit',
                      ...
                      buildRadioQuestion(
                        "Sur quoi doit-être basée lefficacité de la prière ?",
                        [
                          'Sur les statues',
                          'Sur les anges',
