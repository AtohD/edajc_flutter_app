...
class EvaluationFormPage1 extends StatefulWidget {
  ...
  @override
  State<EvaluationFormPage1> createState() => _EvaluationFormPageState();
}

class _EvaluationFormPageState extends State<EvaluationFormPage1> {
  ...
  final Map<String, String> bonnesReponses = {
    'q1': 'La PAROLE c\'est JESUS',
    'q2': 'Avant la fondation du Monde',
    'q3': 'JESUS-CHRIST',
    'q4': 'A JESUS',
    'q5': 'JESUS-CHRIST',
  };
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Text(
                          "(THÈME : JESUS CREATEUR DE L'UNIVERS VISIBLE ET INVISIBLE)",
                          style:
                      ...
                      buildRadioQuestion(
                        ...
                        [
                          ...
                          'La PAROLE c\'est le PERE',
                          'La Parole c\'est le langage',
                          'La Parole c\'est le SAINT-ESPRIT',
                          'Je ne sais pas',
                        ],
                        q1,
                        (val) => setState(() => q1 = val),
                      ...
                      buildRadioQuestion(
                        "A quel moment JESUS a commencé à exister ?",
                        [
                          'JESUS a commencé à exister après sa naissance par Marie',
                      ...
                      buildRadioQuestion(
                        "Dans Genèse 1 verset 26, quand DIEU dit « faisons » à qui pouvait-il parler ?",
                        [
                          'A Adam et Eve',
                          'Au SAINT-ESPRIT',
                          'A JESUS',
                      ...
                      buildRadioQuestion(
                        "Qui se révélait à David, Abraham et Moïse ?",
                        [
                          'Marie',
                          'Le PERE',
                          'JESUS-CHRIST',
