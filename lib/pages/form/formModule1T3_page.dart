...
class EvaluationFormPage3 extends StatefulWidget {
  final String module;
  final String theme;
  final DocumentSnapshot? document;

  const EvaluationFormPage3({
  ...
  @override
  State<EvaluationFormPage3> createState() => _EvaluationFormPageState();
}

class _EvaluationFormPageState extends State<EvaluationFormPage3> {
  ...
  final Map<String, String> bonnesReponses = {
    ...
    'q2': 'C\'est DIEU qui l\'a fait venir',
    'q3':
        'C\'est après sa mort et sa résurrection qu\'IL a envoyé le SAINT-ESPRIT ',
    'q4': 'Pour ne pas être limité',
    'q5': 'Par imposition des mains',
    'q5s': 'Par la prière',
  };
                    ...
                    children: [
                      ...
                      buildRadioQuestion(
                        ...
                        [
                          'C\'est JESUS',
                          'C\'est un ange',
                          'C\'est une entité, il est la troisième personne après JESUS et Il est un autre consolateur',
                          'C\'est DIEU',
                          'Je ne sais pas',
                        ],
                        q1,
                      ...
                      buildRadioQuestion(
                        "Qui L'a fait venir ?",
                        [
                          'C\'est un ange qui l\'a fait venir',
                          'C\'est DIEU qui l\'a fait venir',
                          'Le SAINT-ESPRIT est venu sur la demande de JESUS',
                          'Ce sont les disciples qui l\'ont fait venir',
                          'Je ne sais pas',
                        ],
                        q2,
                        (val) => setState(() => q2 = val),
                      ...
                      buildRadioQuestion(
                        "A quel moment JESUS a fait venir le SAINT-ESPRIT ?",
                        [
                      ...
                      buildRadioQuestion(
                        "Pourquoi le SAINT-ESPRIT est venu en esprit ?",
                        [
                          'Pour ne pas se faire voir ',
                          'Pour ne pas mentir',
                          'Pour ne pas être limité',
                          'Pour ne pas être fort',
                          'Je ne sais pas',
                        ],
                        q4,
                        (val) => setState(() => q4 = val),
