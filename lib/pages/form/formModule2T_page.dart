...
class EvaluationFormPage8 extends StatefulWidget {
  final String module;
  final String theme;
  final DocumentSnapshot? document;

  const EvaluationFormPage8({
  ...
  @override
  State<EvaluationFormPage8> createState() => _EvaluationFormPageState();
}

class _EvaluationFormPageState extends State<EvaluationFormPage8> {
  ...
  final Map<String, String> bonnesReponses = {
    'q1': 'Jeudi',
    'q2':
        'Le sang de JESUS, le feu de DIEU, les pas de DIEU, l\'épée du SEIGNEUR, le jeûne, la main de l\'ETERNEL',
    'q3': 'Le Sang de JESUS',
    'q4':
        'Cacher son âme et son esprit dans le Sang de JESUS  et Confesser que JESUS CHRIST nous a donné le pouvoir de marcher sur les serpents et les scorpions',
  };
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // QUESTIONS RADIO
                      buildRadioQuestion(
                        " Quel est le jour qui a été donné pour le combat spirituel ?",
                        [
                          'Samedi',
                          'Mardi',
                          'Jeudi',
                      ...
                      buildRadioQuestion(
                        "Quelles sont les âmes spirituelles ?",
                        [
                          'Le bois',
                          'Le fer',
                          'Le sang de JESUS, le feu de DIEU, les pas de DIEU, l\'épée du SEIGNEUR, le jeûne, la main de l\'ETERNEL',
                      ...
                      buildRadioQuestion(
                        "Quelle est l'arme fatale dans le combat spirituel ?",
                        [
                          'L\'épée',
                          'Pistolet',
                          'Le Sang de JESUS',
                      ...
                      buildRadioQuestion(
                        "Comment combattre ?",
                        [
                          'Avoir un bon pistolet',
                          'S\'armer de force et de courage',
                          'Cacher son âme et son esprit dans le Sang de JESUS  et Confesser que JESUS CHRIST nous a donné le pouvoir de marcher sur les serpents et les scorpions',
                          'se laver avec de l\'eau, faire des ablutions et citer des passages de la bible',
                          'Je ne sais pas',
                        ],
                        q4,
                        (val) => setState(() => q4 = val),
                          ...
                          onPressed: () async {
                            if (_formKey.currentState!.validate()) {
                              ...
                              if (note >= 3) {
                                title = "🎉 Félicitations !";
                                message =
                                    "Bravo, vous avez obtenu $note / 4.\nContinuez comme ça !";
                                color = Colors.green;
                              } else {
                                title = "📘 Résultat";
                                message =
                                    "Vous avez obtenu $note / 4.\nNe vous découragez pas, continuez à apprendre !";
                                color = Colors.orange;
                              }
