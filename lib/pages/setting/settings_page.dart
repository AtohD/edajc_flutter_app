...
class SettingsPage extends LayoutWidget {
  ...
  // _titleWidget helper removed (unused)

  final ValueNotifier<String> dateNotifier = ValueNotifier("");

  final ValueNotifier<bool> checkNotifier = ValueNotifier(false);
  final ValueNotifier<bool> checkNotifier1 = ValueNotifier(false);
  final ValueNotifier<bool> checkNotifier3 = ValueNotifier(false);
  ...
  final DropzoneViewController? dropzoneViewController = null;
