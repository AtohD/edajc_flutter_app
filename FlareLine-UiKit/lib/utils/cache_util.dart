...
class CacheUtil {
  ...
  String? read(String key) {
    final dynamic raw = _box.read(getCacheKey(key));
    if (raw == null) return null;
    final String json = raw is String ? raw : raw.toString();
    if (json.isEmpty) return null;
    CacheEntity item = CacheEntity.fromJson(jsonDecode(json) as Map<String, dynamic>);
